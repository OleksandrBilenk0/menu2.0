...
const menu = [
    ...
    },
    {
        ...
        desc: `Мікс салату, соус французький,Горгонзола, куряче філе,  масло вершкове, томати в'ялені.`,
    },
    {
        id: 5,
        title: "Овочевий",
    ...
    // Гарячі закуски
    {
        ...
        desc: `Філе риби Минтай обсмажене в паніровці та великій кількості масла . Подаються з соусом Тар-тар. В порції 5 паличок.`,
    },
    {
        id: 6,
        title: "Аранчіні",
        ...
        desc: `Традиційна закуска Сицилії. Рис Арборіо попередньо відварений , в кульку рису кладуть крем-сир, в'ялені томати . Паніруються та смажаться в олії. Подаються з вершковим песто. `,
    },
    {
        id: 6,
        ...
        desc: `Тигрова креветка , обгорнута кокосовим панінруванням та обсмажені в олії. В порції 10 креветок. Подаються з соусом bbq.`,
    },
    {
        id: 6,
