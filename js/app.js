...
const menu = [
    ...
    {
        id: 1,
        title: "Яєшня з ростбіфом та томатами",
        category: "Сніданки",
        price: "₴250",
    ...
    {
        id: 1,
        title: "Великий італійський сніданок із скремблом та прошуто",
        category: "Сніданки",
        price: "₴320",
    ...
    {
        id: 1,
        title: "Яйця пашот-сюпрем <br> з лососем ",
        category: "Сніданки",
        price: "₴287",
    ...
    {
        id: 1,
        title: "Сирники з солоною карамеллю та бананом",
        category: "Сніданки",
        price: "₴250",
    ...
    {
        id: 5,
        title: "Стейк -салат з грісіні <br> (300г.)",
        category: "Салати",
        price: "₴340",
    ...
    {
        id: 6,
        title: "Курячі крильця під соусом BBQ <br> (300г.)",
        category: "Гарячі закуски",
        price: "₴280",
    ...
    {
        id: 6,
        title: "Баклажани Пармеджано <br> (290г.)",
        category: "Гарячі закуски",
        price: "₴195",
    ...
    {
        id: 9,
        title: "Піца -бургер <br> (450г.)",
        category: "Піца",
        price: "₴380",
        img: "./img/09піца/0911.png",
        desc: `Cир моцарела, сир чедер ,соус, кранч-цибуля,мариновані огірки,фарш`,
    },
    {
        id: 9,
        title: "BBQ <br> (480г.)",
    ...
    {
        id: 12,
        title: "Паста шпинатна з куркою та грибами <br> (300г.)",
        category: "Паста",
        price: "₴230",
    ...
    {
        id: 12,
        title: "Лазанья з куркою та грибами <br> (400г.)",
        category: "Паста",
        price: "₴265",
    ...
    },
    {
        ...
        desc: `Нагетси, сир фрі, рибні палички, картопля фрі, солоні хлібці, мідії фрі, соус`,
    },
    {
        id: 14,
        ...
        desc: `Курячі кила, чипси з лаваша, мисливські ковбаски, картопля фрі ,соус`,
    },
    // Страви з м'яса
    {
        id: 15,
    ...
    },
    {
        ...
        price: "₴295",
        img: "./img/15м'ясо/1507.png",
        desc: `З картопляно-вершковим кремом та грибним журом`,
    },
